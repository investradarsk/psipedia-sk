...
const payload={events:[{id:item.id,status:item.status,updatedAt:'stale'}],status:'published',confirmedCount:1};
...
console.log('PASS: actual local D1 API: 175/4/171; cross-origin, stale and count guards; no data changed; list and editor SSR HTTP 200.');
