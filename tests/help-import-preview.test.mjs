...
const categories = ["utulky", "adopcia", "zbierky"];
...
function input(overrides = {}) {
  return {
    ...
    organization: "OZ Priateľ", city: "Nitra", region: "Nitriansky kraj", locationNote: "Okres: Nitra",
...
function production(overrides = {}) {
  ...
  return {
    ...
    excerpt: source.excerpt, description: source.description, organization: source.organization,
...
test("same contact identity or site domain across locations is not automatically NEW", () => {
...
test("shared legal operator across different titles and locations flags special conflict for human review", () => {
