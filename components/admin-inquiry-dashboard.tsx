  ...
  return (
    <>
      ...
      <section className="admin-panel">
        ...
        {visible.length ? <div className="admin-inquiry-list">{visible.map((inquiry) => <article id={`dopyt-${inquiry.id}`} className={`admin-inquiry-card is-${inquiry.status}`} key={inquiry.id}>
