...
export function AdminHelpEditor({ item }: { item?: HelpCase }) {
  ...
  const [actionLabel, setActionLabel] = useState(item?.actionLabel ?? defaultHelpActionLabel("docasna-opatera"));
