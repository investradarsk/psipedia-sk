...
function AdminNavigation() {
  return (
    <nav className="admin-section-nav flex-wrap max-[760px]:flex-nowrap" aria-label="Redakčné moduly">
      ...
      <div className="admin-nav-group"><span style={ADMIN_NAV_GROUP_LABEL_STYLE}>Komunita</span><div><Link href="/admin/automatizacie">Automatizácie</Link><Link href="/admin/operations">Operácie</Link><Link href="/admin/partners">Partneri</Link><Link href="/admin/recenzie-profilov">Profilové recenzie</Link><Link href="/admin/tipy">Tipy</Link><Link href="/admin/hodnotenia">Hodnotenia</Link><Link href="/admin/dopyty">Dopyty</Link></div></div>
