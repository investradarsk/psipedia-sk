...
export async function AdminShell({ user, eyebrow, title, description, actions, children }: { user: ChatGPTUser; eyebrow: string; title: string; description?: string; actions?: ReactNode; children: ReactNode; }) {
