...
function AdminNavigation() {
  return (
    <nav className="admin-section-nav flex-wrap max-[760px]:flex-nowrap" aria-label="Redakčné moduly">
      ...
      <div className="admin-nav-group"><span style={ADMIN_NAV_GROUP_LABEL_STYLE}>Nastavenia</span><div><Link href="/admin/navigacia">Navigácia</Link><Link href="/admin/monetizacia">Monetizácia</Link><Link href="/admin/pravne">Právne</Link><Link href="/admin/import">Import</Link></div></div>
