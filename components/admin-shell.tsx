    ...
    <main id="obsah" className="admin-root">
      <div className="admin-shell shell">
        ...
        <nav className="admin-section-nav" aria-label="Redakčné moduly">
          ...
          <div className="admin-nav-group"><span>Portál</span><div><Link href="/admin/podujatia">Podujatia</Link><Link href="/admin/adresar">Adresár</Link><Link href="/admin/adresar/navrhy">Návrhy úprav</Link><Link href="/admin/pomoc">Pomoc</Link><Link href="/admin/adopcie">Adopcie</Link></div></div>
