...
export const portalSections: PortalSection[] = [
  ...
  },
  {
    ...
    subpages: [
      {
        slug: "pred-kupou-psa", label: "Pred kúpou psa", icon: "🤔", description: "Rozhodnutie, pripravenosť domácnosti, čas, náklady a zodpovednosť.",
        intro: "Pes zmení denný režim na mnoho rokov. Pred rozhodnutím si realisticky prejdi čas, rozpočet, bývanie aj to, kto prevezme starostlivosť, keď ju nezvládneš ty.",
        popularTopics: ["Čas a denný režim", "Náklady", "Bývanie", "Zodpovednosť rodiny"],
        commonQuestions: ["Máme na psa dosť času každý deň?", "Koľko môže stáť prvý rok?", "Je na psa pripravená celá domácnosť?"],
        homeSteps: ["Spíš si bežný pracovný aj víkendový režim.", "Vytvor rozpočet na kúpu, výbavu, krmivo a veterinára.", "Dohodni si plán starostlivosti počas dovolenky a choroby."],
        warningSigns: ["Rozhodnutie vzniká impulzívne alebo ako prekvapenie.", "Výber sa riadi iba vzhľadom psa.", "Nikto nevie zabezpečiť pravidelný pohyb a kontakt."],
        expertAdvice: "Ak sa potreby psa nevojdú do vášho reálneho dňa, odloženie rozhodnutia je zodpovednejšie než spoliehanie sa, že sa režim vyrieši sám.",
        serviceLinks: [{ label: "Ako vybrať plemeno", href: "/plemena/vyber-plemena" }, { label: "Chovateľské stanice", href: "/adresar/chovatelske-stanice" }],
      },
      {
        slug: "vyber-plemena", label: "Výber plemena", icon: "🐕", description: "Povaha, veľkosť, aktivita a potreby plemena podľa tvojho života.",
        intro: "Dobrý výber stojí na zhode medzi potrebami psa a tvojím bežným životom. Porovnávaj energiu, povahu, zdravie a starostlivosť, nielen veľkosť alebo vzhľad.",
        popularTopics: ["Povaha", "Energia", "Veľkosť", "Srsť a údržba"],
        commonQuestions: ["Ktoré plemeno zvládne náš denný režim?", "Je vhodné k deťom alebo iným zvieratám?", "Koľko pohybu a starostlivosti potrebuje?"],
      ...
      {
        slug: "vyber-chovatela", label: "Výber chovateľa", icon: "🏡", description: "Ako spoznať zodpovedný chov, overiť zdravie rodičov a vyhnúť sa množiteľom.",
        intro: "Zodpovedný chovateľ otvorene ukáže podmienky, matku šteniat, zdravotné výsledky aj dokumenty. Zaujíma sa tiež o to, kam jeho šteňa odchádza.",
        popularTopics: ["Návšteva chovu", "Zdravotné testy", "Preukaz pôvodu", "Kúpna zmluva"],
        commonQuestions: ["Čo musí chovateľ ukázať?", "Kedy môže šteňa odísť domov?", "Ako rozoznať množiteľa?"],
        homeSteps: ["Navštív chov osobne a sleduj prostredie aj správanie psov.", "Over zdravotné vyšetrenia rodičov podľa plemena.", "Prečítaj si zmluvu a podmienky odovzdania vopred."],
        warningSigns: ["Odovzdanie má prebehnúť na parkovisku alebo bez návštevy.", "Chýba matka, dokumenty alebo vysvetlenie zdravotných testov.", "Predávajúci tlačí na rýchlu zálohu a ponúka veľa plemien."],
        expertAdvice: "Preukaz pôvodu nie je luxusný doplnok. Je to dohľadateľný pôvod; sám však nenahrádza návštevu, testy ani dobré podmienky odchovu.",
        serviceLinks: [{ label: "Chovateľské stanice", href: "/adresar/chovatelske-stanice" }, { label: "Chovateľské kluby", href: "/adresar/chovatelske-kluby" }],
      },
      {
      ...
      },
      {
        ...
        intro: "Socializácia nie je zbieranie čo najväčšieho počtu stretnutí. Cieľom sú krátke, bezpečné skúsenosti, pri ktorých šteňa môže pozorovať, ustúpiť a zostať v pohode.",
        popularTopics: ["Ľudia a deti", "Psy", "Zvuky a prostredie", "Pokojná manipulácia"],
        commonQuestions: ["Kedy začať so socializáciou?", "Musí sa hrať s každým psom?", "Čo robiť, keď sa bojí?"],
        homeSteps: ["Nové podnety dávkuj po jednom a z bezpečnej vzdialenosti.", "Odmeň pokojné pozorovanie, nie nútený kontakt.", "Nauč šteňa, že odchod a oddych sú vždy možné."],
        warningSigns: ["Šteňa tuhne, skrýva sa, odmieta jedlo alebo sa snaží utiecť.", "Cudzí ľudia ho dvíhajú alebo hladkajú bez možnosti odstúpiť.", "Kontakt so psami je chaotický, tvrdý alebo bez prestávok."],
        expertAdvice: "Ak strach pretrváva alebo sa zhoršuje, vyhľadaj trénera pracujúceho bez nátlaku. Včasná pomoc býva jednoduchšia než riešenie rozvinutého problému.",
        serviceLinks: [{ label: "Tréneri a školy", href: "/adresar/treneri" }, { label: "Kynologické kluby", href: "/adresar/kynologicke-kluby" }],
      },
      {
        slug: "hygiena", label: "Hygiena", icon: "🧼", description: "Čistotnosť, srsť, pazúry, zuby, uši a pokojná manipulácia.",
        intro: "Krátke a príjemné dotyky od prvých dní pripravia šteniatko na česanie, kontrolu uší, zubov, labiek aj veterinárne ošetrenie.",
        popularTopics: ["Čistotnosť", "Zuby", "Pazúry", "Srsť a uši"],
        commonQuestions: ["Ako učiť čistotnosť bez trestu?", "Kedy začať čistiť zuby?", "Ako zvyknúť šteňa na pazúry?"],
        homeSteps: ["Manipuláciu rozdeľ na niekoľkosekundové kroky.", "Za pokojný dotyk odmeň a skonči skôr, než sa šteňa začne brániť.", "Používaj pomôcky vhodné pre vek, srsť a veľkosť psa."],
        warningSigns: ["Za nehody šteňa trestáš alebo mu v nich namáčaš ňufák.", "Ucho, koža alebo labka je bolestivá, opuchnutá či zapácha.", "Pri manipulácii sa strach opakovane stupňuje."],
        expertAdvice: "Bolestivú manipuláciu netrénuj silou. Najprv vylúč zdravotný problém a potom postupuj s veterinárom, groomerom alebo citlivým trénerom.",
        serviceLinks: [{ label: "Psie salóny", href: "/adresar/salony-a-sluzby" }, { label: "Nájsť veterinára", href: "/adresar/veterinari" }],
      },
      {
        slug: "krmenie", label: "Kŕmenie", icon: "🥣", description: "Dávka, režim, zmena krmiva a sledovanie zdravej kondície.",
        intro: "Rastúci pes potrebuje kompletné krmivo primerané veku a očakávanej veľkosti. Dávku upravuj podľa kondície, nie iba podľa tabuľky na obale.",
        popularTopics: ["Denná dávka", "Zmena krmiva", "Maškrty", "Telesná kondícia"],
        commonQuestions: ["Koľkokrát denne má šteňa jesť?", "Ako bezpečne zmeniť krmivo?", "Je moje šteňa príliš chudé?"],
        homeSteps: ["Rozdeľ dennú dávku do viacerých pravidelných jedál.", "Nové krmivo zavádzaj postupne a sleduj trávenie.", "Maškrty započítaj do celkového denného príjmu."],
        warningSigns: ["Šteňa odmieta jedlo, opakovane vracia alebo má silnú hnačku.", "Brucho je náhle nafúknuté a bolestivé.", "Doplnky vápnika alebo vitamínov podávaš bez odporúčania veterinára."],
        expertAdvice: "Najmä pri veľkých plemenách môže nevhodná energia a pomer živín ovplyvniť rast. Jedálniček a doplnky konzultuj s veterinárom.",
        serviceLinks: [{ label: "Výživa psa", href: "/starostlivost/vyziva" }, { label: "Nájsť veterinára", href: "/adresar/veterinari" }],
      },
      {
        slug: "ockovanie-a-zdravie", label: "Očkovanie a zdravie", icon: "💉", description: "Očkovanie, odčervenie, prevencia a situácie, keď volať veterinára.",
        intro: "Veterinár nastaví očkovanie a prevenciu podľa veku, zdravotného stavu a rizík v prostredí. Maj po ruke dokumenty a všímaj si zmeny správania, príjmu vody a trávenia.",
        popularTopics: ["Očkovací plán", "Odčervenie", "Parazity", "Prvá prehliadka"],
        commonQuestions: ["Kedy má byť prvá návšteva veterinára?", "Kedy môže šteňa bezpečne medzi psy?", "Čo je po očkovaní normálne?"],
        homeSteps: ["Objednaj vstupnú prehliadku krátko po príchode.", "Prines očkovací preukaz alebo pas a záznamy od chovateľa.", "Sleduj chuť do jedla, stolicu, močenie, energiu a hmotnosť."],
        warningSigns: ["Sťažené dýchanie, kolaps, kŕče alebo silná alergická reakcia.", "Opakované vracanie, krvavá hnačka alebo výrazná apatia.", "Šteňa neprijíma vodu alebo sa jeho stav rýchlo zhoršuje."],
        expertAdvice: "Pri šteniatku sa stav môže zhoršiť rýchlo. Ak si neistý, zavolaj veterinárovi a opíš vek, hmotnosť, príznaky a ich trvanie.",
        serviceLinks: [{ label: "Nájsť veterinára", href: "/adresar/veterinari" }, { label: "Zdravie psa", href: "/starostlivost/zdravie" }],
      },
      {
        slug: "vycvik-steniatka", label: "Výcvik šteniatka", icon: "🦮", description: "Meno, privolanie, vodítko a základy spolupráce bez nátlaku.",
        intro: "Najlepší prvý tréning je krátky, zrozumiteľný a končí úspechom. Buduj pozornosť, privolanie a pokojné fungovanie skôr než dlhý zoznam povelov.",
        popularTopics: ["Meno a pozornosť", "Privolanie", "Vodítko", "Samota"],
        commonQuestions: ["Ako dlho má trvať tréning?", "Čo robiť, keď šteňa hryzie?", "Ako začať s privolaním?"],
        homeSteps: ["Trénuj v minútových blokoch v pokojnom prostredí.", "Odmeň správanie, ktoré chceš vidieť častejšie.", "Náročnosť zvyšuj až po úspechu bez rušivých vplyvov."],
        warningSigns: ["Používaš fyzické tresty, krik alebo zastrašovanie.", "Od šteniatka očakávaš sústredenie ako od dospelého psa.", "Samotu predlžuješ napriek panike alebo sebapoškodzovaniu."],
        expertAdvice: "Pri strachu, panike, obrannom správaní alebo opakovanom zlyhávaní si vyber trénera, ktorý pracuje bez bolesti a nátlaku.",
        serviceLinks: [{ label: "Tréneri a školy", href: "/adresar/treneri" }, { label: "Výcvik psa", href: "/starostlivost/vycvik" }],
      },
      {
        slug: "rast-a-vyvoj", label: "Rast a vývoj", icon: "📏", description: "Vývoj tela a správania, výmena zubov, pohyb a primerané zaťaženie.",
        intro: "Rast neprebieha rovnomerne. Pohyb prispôsobuj veku, povrchu, stavbe tela a únave; namiesto nútených kilometrov uprednostni voľný pohyb, objavovanie a oddych.",
        popularTopics: ["Výmena zubov", "Hmotnosť", "Pohyb", "Spánok"],
        commonQuestions: ["Koľko pohybu je primerané?", "Kedy sa menia zuby?", "Ako sledovať zdravý rast?"],
        homeSteps: ["Pravidelne sleduj hmotnosť aj telesnú kondíciu.", "Dopraj veľa spánku a voľný pohyb na bezpečnom povrchu.", "Záťaž zvyšuj postupne a všímaj si únavu po aktivite."],
        warningSigns: ["Krívanie, neochota vstať alebo bolesť po pohybe.", "Nútené behanie pri bicykli, vysoké skoky alebo dlhé schody.", "Rýchla zmena hmotnosti alebo dlhodobé tráviace ťažkosti."],
        expertAdvice: "Univerzálny počet minút neplatí pre každé šteňa. Pri veľkom plemene, krívaní alebo neistote nastav pohyb s veterinárom či fyzioterapeutom.",
        serviceLinks: [{ label: "Fyzioterapia", href: "/adresar/fyzioterapia" }, { label: "Nájsť veterinára", href: "/adresar/veterinari" }],
        featuredArticleSlugs: ["prvy-rok-labradora-mesiac-po-mesiaci"],
      },
      {
        slug: "puberta", label: "Puberta", icon: "🌱", description: "Zmeny správania, hranice, emócie a tréning počas dospievania.",
        intro: "Dospievanie môže priniesť väčšiu samostatnosť, citlivosť aj kolísanie sústredenia. Vráť sa k jednoduchším podmienkam a zachovaj pravidlá bez tvrdosti.",
        popularTopics: ["Privolanie", "Emócie", "Hranice", "Kontakt so psami"],
        commonQuestions: ["Prečo zrazu nepočúva?", "Ako zvládnuť silné emócie?", "Kedy pes dospieva?"],
        homeSteps: ["Dočasne zníž náročnosť a častejšie odmeň úspech.", "Použi dlhé vodítko tam, kde privolanie ešte nie je spoľahlivé.", "Udržuj pravidelný režim, spánok a pokojné prestávky."],
        warningSigns: ["Zmeny správania pripisuješ puberte bez vylúčenia bolesti.", "Konflikty riešiš silou alebo opakovaným trestaním.", "Pes ohrozuje seba, ľudí alebo iné zvieratá."],
        expertAdvice: "Náhla alebo výrazná zmena správania môže súvisieť so zdravím. Najprv vylúč bolesť; pri pretrvávajúcom probléme zapoj vhodného trénera alebo behavioristu.",
        serviceLinks: [{ label: "Tréneri a školy", href: "/adresar/treneri" }, { label: "Správanie psa", href: "/starostlivost/spravanie" }],
      },
    ],
  },
  {
