...
export const defaultNavigationItems: NavigationItem[] = [
  { id: "plemena", label: "Plemená", href: "/plemena", parentId: null, position: 0, visible: true },
  { id: "steniatka", label: "Šteniatka", href: "/steniatka", parentId: null, position: 1, visible: true },
  { id: "starostlivost", label: "Zdravie a starostlivosť", href: "/starostlivost", parentId: null, position: 2, visible: true },
  { id: "aktivity", label: "Výcvik a aktivity", href: "/aktivity", parentId: null, position: 3, visible: true },
  { id: "adresar", label: "Služby pre psov", href: "/adresar", parentId: null, position: 4, visible: true },
