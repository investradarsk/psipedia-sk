CREATE TABLE adoption_dogs__org6b (
  ...
  organization_id INTEGER REFERENCES help_organizations(id) ON DELETE RESTRICT,
...
INSERT INTO adoption_dogs__org6b (
  id, name, slug, status, sex, birth_date, approximate_age_months, size, weight, breed_id, breed_name, breed_mix,
  color, region, district, city, organization_id, organization_name, organization_slug, main_image, gallery_json,
...
DROP TABLE adoption_dogs;
ALTER TABLE adoption_dogs__org6b RENAME TO adoption_dogs;
