...
import { createManagedBreed, listManagedBreeds, type ManagedBreedInput } from "@/lib/breed-store";
export const dynamic="force-dynamic";
export async function GET(){const user=await getAdminApiUser();return user?Response.json({breeds:await listManagedBreeds()}):unauthorizedAdminResponse();}
