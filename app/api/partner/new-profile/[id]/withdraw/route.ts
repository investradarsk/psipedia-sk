...
import { PartnerNewProfileError, withdrawPartnerNewProfile } from "@/lib/partner-new-profile";
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const submission = await withdrawPartnerNewProfile({ accountId: identity.accountId, id });
